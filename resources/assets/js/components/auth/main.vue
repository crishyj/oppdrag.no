<template>
  <div class="verticle-align auth-main-wrapper" style="background-color: #fff;">
    <div class="inner">
      ...
      <div class="text-center">
          <h2 class="auth-title">Welcome to Oppdrag
            <span class="auth-title-desc" >{{message}}</span>
          </h2>
      </div>
      <div class="auth-panel active bg-primary-gradient">
